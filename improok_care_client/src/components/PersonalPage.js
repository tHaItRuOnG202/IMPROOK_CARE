...
const PersonalPage = () => {
    ...
    return <>
        <div class="PersonalPage_Wrapper">
                                ...
                                <div class="PersonalPage_Right_Content">
                                    <div class="Personal_Avatar">
                                        {current_avatar === null ? <>
                                            ...
                                            <div><Image class="user_Avatar" src={current_user.avatar} style={{ width: "20%" }} alt="Not Found" rounded /></div>
                                        </>}
                            ...
                            <section>
                                ...
                                <div class="PersonalPage_Right_Content">
                                    ...
                                    <div class="Personal_Gender">
                                        ...
                                        <div class="Personal_Gender_Tick">
