...
import setting from "../assests/images/settings.png"
import timetable from "../assests/images/timetable.png"
import phonecall from "../assests/images/phone-call.png"
import medicalapp from "../assests/images/medical-app.png"
import bannerheader from "../assests/images/banner-header.png"
import advice from "../assests/images/advice.png"
import managementapp from "../assests/images/management-app.png"
import collabdoctor from "../assests/images/collab-doctor-register.png"
        ...
        <div class="CollabDoctor_Wrapper">
            <div class="CollabDoctor_Content">
                <div class="CollabDoctor_Content_1">
                    <div class="CollabDoctor_Content_1_Header">
                        ...
                        <div>
                            <p>IMPROOK cung cấp giải <strong>pháp chuyển đổi số</strong> giúp bác sĩ vận hành phòng khám hiệu quả,
            ...
            <div class="CollabDoctor_Content">
                <div class="CollabDoctor_Content_2">
                    <div class="CollabDoctor_Content_2_Detail_1">
                        <div>
                    ...
                    <div class="CollabDoctor_Content_2_Detail_2">
                        <div>
                            <img src={timetable} alt="timetable" width={'40%'} />
                            <h4>Ứng dụng <span>Quản lý lịch khám</span></h4>
                            <ul>
                    ...
                    <div class="CollabDoctor_Content_2_Detail_3">
                        <div>
                            <img src={phonecall} alt="phonecall" width={'40%'} />
                            <h4>Nền tảng <span>Tư vấn trực tuyến</span></h4>
                            <ul>
                ...
                <div class="CollabDoctor_Content_3">
                    ...
                    <div class="CollabDoctor_Content_3_Content">
                        ...
                        <div class="CollabDoctor_Content_3_RightContent">
                            <div >
                ...
                <div class="CollabDoctor_Content_5">
                    <div class="CollabDoctor_Content_5_Header">
                        <div>
                            <img src={managementapp} alt="Management App" width={"70%"} />
                        </div>
                    </div>
                    <div class="CollabDoctor_Content_5_Content">
                        <div>
                ...
                <div class="CollabDoctor_Content_6" id="register_collab">
                    <div class="CollabDoctor_Content_6_Header">
                        <div className="mb-3">
                            <h1 className="mb-3">Hợp tác với <strong>IMPROOK</strong> ngay!</h1>
                        ...
                        <Form onSubmit={(e) => addCollabDoctor(e)}>
                            ...
                            <div class="Collab_Butt">
                                <button type="submit">Gửi thông tin</button>
                            </div>
                        </Form>
                    </div>
                    <div class="CollabDoctor_Content_6_Content">
                        <div>
            ...
            <div class="CollabDoctor_Content_7">
                <div>
                    <div class="CollabDoctor_Content_7_Left">
                    ...
                    <div class="CollabDoctor_Content_7_Right">
                    </div>
                </div>
            </div>
        </div>
